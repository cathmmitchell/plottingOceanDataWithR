...
The data file is called `DamariscottaRiverData.csv` and is [in the data folder in the GitHub repository](https://github.com/cathmmitchell/plottingOceanDataWithR). If you haven't already, please download the file and save it in your working directory. You can download the file by:
